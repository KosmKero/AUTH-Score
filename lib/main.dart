...
List<Team> teams = [
  Team("Ολυμπιακός", 10, 7, 2, 1, 1, 2000, 0, [
    Player("Γιώργαρας", "Παπαδόπουλος", 2, 5, 10, 22,"Olympiacos"),
    Player("Πετρος", "Ππα", 2, 5, 5, 21, "Olympiacos"),
    Player("Φανης", "Κωνστα", 2, 5, 5, 20, "Olympiacos"),
    Player("Ποαλ", "Πολο", 2, 5, 5, 19, "Olympiacos"),
    Player("Γιώργος", "Παπαδόπουλος", 0, 5, 5, 25, "Olympiacos"),
    Player("Γιώργος", "Παπαδόπουλος", 0, 5, 5, 24, "Olympiacos"),
    Player("Γιώργος", "Παπαδόπουλος", 1, 5, 5, 23, "Olympiacos"),
    Player("Νίκος", "Λαμπρόπουλος", 2, 3 ,3  , 22, "Olympiacos"),
    Player("Γιώργαρας", "Παπαδόπουλος", 2, 5, 10, 22,"Olympiacos"),
    Player("Πετρος", "Ππα", 2, 5, 5, 21, "Olympiacos"),
    Player("Φανης", "Κωνστα", 2, 5, 5, 20, "Olympiacos"),
    Player("Ποαλ", "Πολο", 2, 5, 5, 19, "Olympiacos"),
