...
class BasketMatchNotStartedDetails extends StatefulWidget {
  ...
  @override
  State<BasketMatchNotStartedDetails> createState() => _BasketMatchNotStartedDetailsState();
}

class _BasketMatchNotStartedDetailsState extends State<BasketMatchNotStartedDetails> {
  int selectedIndex = 0;
